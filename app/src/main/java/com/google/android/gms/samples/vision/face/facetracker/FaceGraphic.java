...
class FaceGraphic extends GraphicOverlay.Graphic {
    ...
    static Image imageCanvas = new Image();
    public static  Image getImageFromCanvas(){
        return imageCanvas;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.restore();
//        Matrix tempMat = canvas.getMatrix();
//        Bitmap tempBitmap = null;
//
//
//        imageCanvas.setSaveBitmap(Bitmap.createBitmap(tempBitmap,0,0,
//                1080,1920,tempMat,true));
